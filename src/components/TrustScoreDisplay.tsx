      ...
      {riskFactors.length > 0 && (
        <div className="mb-3">
          ...
          <ul className="text-xs text-red-600 space-y-1">
            {riskFactors.slice(0, isExpanded ? riskFactors.length : 3).map((factor: string, index: number) => (
      ...
      {positiveFactors.length > 0 && (
        <div className="mb-3">
          ...
          <ul className="text-xs text-green-600 space-y-1">
            {positiveFactors.slice(0, isExpanded ? positiveFactors.length : 2).map((factor: string, index: number) => (
              <li key={index}>• {factor}</li>
            ))}
          </ul>
        </div>
